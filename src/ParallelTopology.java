...
public class ParallelTopology {
	...
	private static final String TOPOLOGY_NAME = "parallel-topology";
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt(HASHTAG_BOLT_ID, hashtagBolt, 2).setNumTasks(4).shuffleGrouping(TWEET_SPOUT_ID);
		builder.setBolt(LOSSY_BOLT_ID, lossyBolt, 2).fieldsGrouping(HASHTAG_BOLT_ID, new Fields("hashtag"));
		...
		config.registerSerialization(DataEntity.class);
